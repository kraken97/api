...
namespace WebApplication16.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(SqliteContext context, ILogger<MoviesController> logger)
        {
        ...
        // GET: Movies
        public async Task<IActionResult> Index(string movieGenre, string title, int? year)
        {

            // IQueryable<Movie> res=this._context.Movie;
            // _logger.LogInformation("req "+title+" "+year);
            // if (!String.IsNullOrEmpty(title))
            // {
            //     res =res.Where(r=>r.Title.Contains(title));
            // }
